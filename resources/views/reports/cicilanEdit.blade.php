            ...
            <div class="bg-white p-6 rounded shadow">
                <form action="{{ route('reports.update', $customer->idCustomer) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="cicilan" id="cicilan" value="{{ $customer->cicilan }}"
                            class="w-full px-3 py-2 border rounded focus:ring focus:ring-green-300 format-ribuan" required>
                    </div>
