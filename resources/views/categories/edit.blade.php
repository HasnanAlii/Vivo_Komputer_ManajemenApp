    ...
    <div class="py-10">
        <div class="max-w-lg mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-xl sm:rounded-lg p-6">
                ...
                <form action="{{ route('categories.update', $category->idCategory) }}" method="POST" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <input type="text" name="kodeKategori" id="kodeKategori" required
                            ...
                            value="{{ old('kodeKategori', $category->kodeKategori) }}">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="namaKategori" id="namaKategori" required
                            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2
                                   focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                            value="{{ old('namaKategori', $category->namaKategori) }}">
                    </div>
